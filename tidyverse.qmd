...
- `nest()` converts grouped data to a form where each group becomes a single row containing a nested data frame
- `pivot_longer/ wider()` converts between long and wide forms 
- `drop_na()` make explicit values implicit 
...
## Loading in Palmer Penguins **and** tidyverse
...
# Letuce Code! Please open rstudio 
